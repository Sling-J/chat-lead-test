...
document.body.addEventListener("click", function(t) {
    var e = t.target;
    for (; e && !e.hasAttribute("datatooltip"); )
        e = e.parentElement;
    if (e) {
        for (var n = t.target; n && !n.hasAttribute("datatooltipignore"); )
            n = n.parentElement;
        if (!n) {
            var a = document.querySelector(".active[datatooltip]");
            a && a !== e && a.classList.remove("active"),
            e.classList.toggle("active")
        }
    }
});  
$(".add-button-bor").on("click", function() {
	if($(".add-button-bor").hasClass('active')){
    	$(".add-button-bor").removeClass('active');

	}else{
    	$(".add-button-bor").addClass('active');
	}
});
...
document.body.addEventListener("mousedown", function(t) {
    for (var e = t.target; null !== e && !e.hasAttribute("datatooltipignore") && !e.hasAttribute("datatooltip"); )
        e = e.parentElement;
    if (!e) {
        var n = document.querySelector(".active[datatooltip]");
...
// $(document).ready(side_social_auth());

$('.ui-textarea-toolbar__btn--btn-text').click(function() {
	var div = $(this).parents("section").find(".createBtn:last");
    div.after('<div class="ui-message-row ui-message-row--replies createBtn"><div class="reply-wrapper js-block-wrapper js-block"><div class="ui-conversations__control-btn remove-btn" title="Удалить ответ"></div><div class="form-control-wrapper"><div contenteditable="true" aria-multiline="true" class="form-control form-control--textarea js-content js-vars js-contenteditable js-emoji-unified js-vars-parsed"></div><div class="ui-textarea-toolbar js-emoji-container"><div class="ui-textarea-toolbar__btn ui-textarea-toolbar__btn--emoji js-emoji-picker" data-action="variables_toolbar" datatooltip=""></div><div class="ui-textarea-toolbar__btn ui-textarea-toolbar__btn--options data-action="variables_toolbar" datatooltip=""><div class="text-tooltip text-tooltip--top">Условия отправки</div><div class="ui-tooltip right" datatooltipignore=""><p class="title">Добавить теги</p><ul><li class="js-insert-variable" >тест тег 1</li><li class="js-insert-variable" >тест тег 1</li></ul></div></div><div class="ui-textarea-toolbar__btn ui-textarea-toolbar__btn--typing" data-action="variables_toolbar" datatooltip=""><div class="text-tooltip text-tooltip--top">Эффект печати</div><div class="ui-tooltip top" datatooltipignore=""><p class="title">Эффект печати</p></div></div><div class="ui-textarea-toolbar__btn ui-textarea-toolbar__btn--macros" data-action="variables_toolbar" datatooltip=""><div class="text-tooltip text-tooltip--top">Вставить макрос</div><div class="ui-tooltip right" datatooltipignore=""><div class="c-tooltip a-position"><a href="" target="_blank"></a>?<div class="c-tooltip__content"><p>Нажмите, чтобы узнать о макросах подробнее</p></div></div><p class="title">Макросы</p><ul><li class="js-insert-variable" >Имя</li><li class="js-insert-variable" >Фамилия</li></ul></div></div><div class="ui-textarea-toolbar__btn ui-textarea-toolbar__btn--autovoronka" data-action="variables_toolbar" datatooltip=""><div class="text-tooltip text-tooltip--top">Подключить к автопотоку</div><div class="ui-tooltip right" datatooltipignore=""><p class="title">Подключить к автопотоку</p><ul><li class="js-insert-variable">Автоворонка 1</li><li class="js-insert-variable">Автоворонки 2</li></ul></div></div></div></div><div class="form-control-wrapper"><div class="add-button ui-textarea-toolbar__btn ui-textarea-toolbar__btn--addbtn" data-action="variables_toolbar" datatooltip="">+ ДОБАВИТЬ КНОПКУ<div class="ui-tooltip top" datatooltipignore=""><div class="header__menu"><p class="title">Название кнопки</p><input type="text" placeholder="test"></div><ul><li class="js-insert-variable"><img src="../img/db/send.png" alt="">Отправить сообщение</li><li class="js-insert-variable"><img src="../img/db/link.png" alt="">Внешняя ссылка</li><li class="js-insert-variable"><img src="../img/db/select-step.png" alt="">Выберите существующий шаг</li></ul><div class="add-button add-button-bor ui-textarea-toolbar__btn ui-textarea-toolbar__btn--addbtn" data-action="variables_toolbar" datatooltip="">+ Действия<div class="ui-tooltip right" datatooltipignore=""><ul><li class="js-insert-variable">Убрать тег</li><li class="js-insert-variable">Добавить тег</li></ul></div></div></div></div></div></div></div>');
});
...
function openGraph(evt, graphName) {
	...
	tabcontent = document.getElementsByClassName("tabcontent");
  	...
  	tablinks = document.getElementsByClassName("graph-tablinks");
...
$('input[type="checkbox"]').click(function(){
    if($(this).prop("checked") == true){
        $("#if-check").css("display","inline-block");   
    }
