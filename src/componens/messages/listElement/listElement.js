...
const ListElements = (props) => {
   const {type, index, pictureForLabel, value, changedTrigger, conditionValue} = props;
   ...
   return (
      <div className={style.mainContainer}>
         <ConditionsToggle isOpenConditions={conditionValue.conditions} {...props}/>
         <ConditionsContainer conditions={conditionValue.conditions}/>
