   ...
   return (
      <aside id="sidebar" className={style.setupSidebar}>
         <div className={style.groupBlock}>
            <p className={style.groupBlock__text}>Ваш пробный период заканчивается через 14 дней.<br/><a href="">ВЫБРАТЬ
               ТАРИФ</a></p>
         </div>
         <div className={style.ui_vmenu_sep}>
            ...
            <form action="" className={style.ui_vmenu_sep_form}>
               ...
               <label className={style.ui_vmenu__item + " "}>
                  <input type="radio" name="radio" value="telegram"/><span
                  className={style.ui_vmenu__item_span}>Telegram</span>
               </label>
               <label className={style.ui_vmenu__item + " "}>
                  <input type="radio" name="radio" value="vk"/><span
                  className={style.ui_vmenu__item_span}>Вконтакте</span>
               </label>
               <label className={style.ui_vmenu__item + " "}>
                  <input type="radio" name="radio" value="whatsapp"/><span
                  className={style.ui_vmenu__item_span}>Whatsapp</span>
               </label>
